...
use futures::prelude::*;
use origin_substrate_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	origin_substrate_runtime::api::dispatch,
	origin_substrate_runtime::native_version,
);
...
macro_rules! new_full_start {
	($config:expr) => {{
		...
		let builder = substrate_service::ServiceBuilder::new_full::<
			origin_substrate_runtime::opaque::Block, origin_substrate_runtime::RuntimeApi, crate::service::Executor
		>($config)?
			...
			.with_import_queue(|_config, client, mut select_chain, _transaction_pool| {
				...
				let (grandpa_block_import, grandpa_link) =
					grandpa::block_import::<_, _, _, origin_substrate_runtime::RuntimeApi, _, _>(
